...
/**
 * @brief perform a single SPI write to a ICM20689 register
 *
 * this functions wraps all logic necessary to write to any of the ICM20689
 *   registers, regardless
 * of which memory bank the register belongs to.
 *
 * @param bus SPI bus pointer
 * @param reg address of ICM20689 register to write to
...
/**
 * @brief update a single ICM20689 register value
 *
 * this functions wraps all logic necessary to update any of the ICM20689
 *   registers, regardless
 * of which memory bank the register belongs to.
 *
 * @param bus SPI bus pointer
 * @param reg address of ICM20689 register to update
...
/**
 * @brief read from one or more ICM20689 registers
 *
 * this functions wraps all logic necessary to read from any of the ICM20689
 *   registers, regardless
 * of which memory bank the register belongs to.
 *
 * @param bus SPI bus pointer
 * @param reg start address of ICM20689 register(s) to read from
