...
void ui_ApplicationScreen_screen_init(void)
{
    ...
    lv_img_set_src(ui_imglvgl, &ui_img_lvgl_logo_78_24_png);
    lv_obj_set_width(ui_imglvgl, LV_SIZE_CONTENT);   /// 78
    lv_obj_set_height(ui_imglvgl, LV_SIZE_CONTENT);    /// 25
    lv_obj_set_x(ui_imglvgl, 118);
    lv_obj_set_y(ui_imglvgl, -100);
    lv_obj_set_align(ui_imglvgl, LV_ALIGN_CENTER);
    lv_obj_add_flag(ui_imglvgl, LV_OBJ_FLAG_CLICKABLE | LV_OBJ_FLAG_ADV_HITTEST);     /// Flags
    lv_obj_clear_flag(ui_imglvgl, LV_OBJ_FLAG_PRESS_LOCK | LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    ...
    lv_obj_set_x(ui_labeltextSi7021, -53);
    lv_obj_set_y(ui_labeltextSi7021, -58);
    lv_obj_set_align(ui_labeltextSi7021, LV_ALIGN_CENTER);
    lv_label_set_text(ui_labeltextSi7021, "Si 7021 Relative Humidity and Temperature Sensor");
    lv_obj_set_style_text_font(ui_labeltextSi7021, &lv_font_montserrat_8, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_label_set_text(ui_labelTempValue, "29.75");
    ...
    lv_label_set_text(ui_labelhumidityValue, "78.75");
    ...
    lv_obj_set_x(ui_labelVEML6035, -86);
    lv_obj_set_y(ui_labelVEML6035, -30);
    lv_obj_set_align(ui_labelVEML6035, LV_ALIGN_CENTER);
    lv_label_set_text(ui_labelVEML6035, "VEML6035 Ambient Light Sensor");
    lv_obj_set_style_text_font(ui_labelVEML6035, &lv_font_montserrat_8, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_x(ui_labelSI7210Hall, -103);
    lv_obj_set_y(ui_labelSI7210Hall, -7);
    lv_obj_set_align(ui_labelSI7210Hall, LV_ALIGN_CENTER);
    lv_label_set_text(ui_labelSI7210Hall, "Si 7210 Hall Effect Sensor");
    lv_obj_set_style_text_font(ui_labelSI7210Hall, &lv_font_montserrat_8, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_x(ui_labelBMP384Barometric, -76);
    ...
    lv_obj_set_style_text_font(ui_labelBMP384Barometric, &lv_font_montserrat_8, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_x(ui_labelICM20689, -87);
    lv_obj_set_y(ui_labelICM20689, 48);
    lv_obj_set_align(ui_labelICM20689, LV_ALIGN_CENTER);
    lv_label_set_text(ui_labelICM20689, "ICM-20689 6-Axis Inertial Sensor");
    lv_obj_set_style_text_font(ui_labelICM20689, &lv_font_montserrat_8, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_x(ui_labellxsymbol, 147);
    ...
    lv_obj_set_x(ui_labelmTSymbol, 142);
    ...
    lv_obj_set_x(ui_labelmBarSymbol, 135);
    ...
    lv_obj_set_x(ui_labelOrientation, -130);
    lv_obj_set_y(ui_labelOrientation, 66);
    lv_obj_set_align(ui_labelOrientation, LV_ALIGN_CENTER);
    lv_label_set_text(ui_labelOrientation, "Orientation");
    lv_obj_set_style_text_font(ui_labelOrientation, &lv_font_montserrat_8, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_label_set_text(ui_labelorientXvalue, "24.45");
    ...
    lv_label_set_text(ui_labelorientYvalue, "45.45");
    ...
    lv_obj_set_x(ui_labelDegreesymbol2, -69);
    ...
    lv_label_set_text(ui_labelorientZvalue, "45.45");
    ...
    lv_obj_set_x(ui_labelAcceleration, 116);
    lv_obj_set_y(ui_labelAcceleration, 66);
    lv_obj_set_align(ui_labelAcceleration, LV_ALIGN_CENTER);
    lv_label_set_text(ui_labelAcceleration, "Acceleration");
    lv_obj_set_style_text_font(ui_labelAcceleration, &lv_font_montserrat_8, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_label_set_text(ui_labelg1Value, "0.45");
    ...
    lv_obj_set_x(ui_labelGSymbol1, 51);
    ...
    lv_label_set_text(ui_labelg2Value, "0.45");
    ...
    lv_obj_set_x(ui_labelGSymbol2, 100);
    ...
    lv_label_set_text(ui_labelg3Value, "0.45");
    ...
    lv_obj_set_x(ui_labelGSymbol3, 148);
    ...
    lv_obj_set_style_text_font(ui_labelxg24, &lv_font_montserrat_10, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_x(ui_labelbroadcasted, 34);
    ...
    lv_obj_set_style_text_font(ui_labelbroadcasted, &lv_font_montserrat_10, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_x(ui_labelsecago, 125);
    lv_obj_set_y(ui_labelsecago, 108);
    lv_obj_set_align(ui_labelsecago, LV_ALIGN_CENTER);
    lv_label_set_text(ui_labelsecago, "sec ago");
    lv_obj_set_style_text_font(ui_labelsecago, &lv_font_montserrat_10, LV_PART_MAIN | LV_STATE_DEFAULT);

    lv_obj_add_event_cb(ui_imgbthome, ui_event_imgbthome, LV_EVENT_ALL, NULL);
    lv_obj_add_event_cb(ui_imglvgl, ui_event_imglvgl, LV_EVENT_ALL, NULL);
